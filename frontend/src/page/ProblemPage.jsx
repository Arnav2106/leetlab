                  ...
                  <div key={lang} className="bg-base-200 p-6 rounded-xl mb-6 font-mono">
                    ...
                    {example.explanation && (
                      <div>
                        ...
                        <p className="text-base-content/70 text-lg">{example.explanation}</p>
                      </div>
                    )}
                  </div>
                ))}
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body p-0">
              <div className="tabs tabs-bordered">
                {[
                  { key: "description", icon: <FileText className="w-4 h-4" />, label: "Description" },
                  { key: "submissions", icon: <Code2 className="w-4 h-4" />, label: "Submissions" },
                  { key: "discussion", icon: <MessageSquare className="w-4 h-4" />, label: "Discussion" },
